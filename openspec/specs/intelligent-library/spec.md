...
### Requirement: Scope Boundaries for Remote Intelligence Hardening

This modification MUST NOT require full offline sync/downloads, provider expansion beyond Subsonic scope, cross-server merge/sync playlists, or visual redesign.
