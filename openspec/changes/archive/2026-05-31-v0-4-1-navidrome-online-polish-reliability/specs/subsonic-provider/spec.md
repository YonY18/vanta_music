...
This delta MUST NOT introduce full offline downloads/sync, new provider families (Jellyfin/YT/SMB/WebDAV), complex multi-server merge/sync/cross-server playlists, or visual redesign.
